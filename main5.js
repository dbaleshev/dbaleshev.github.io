...
// Reference: W3Schools. (n.d.). Relative Lengths. https://www.w3schools.com/cssref/css_units.php
// Reference: OpenAl. (2024). ChatGPT (March 2024 version) [Large language model]. Used to apply for all website sections. https://chat.openai.com/chat
document.getElementById("certificationOutput").innerHTML = "Your Selected Certification: " + certification;
function adjustFontSize(size) {
    document.body.style.fontSize = size + 'em';
    }

function changeColor(scheme) {     // Reference: OpenAl. (2024). ChatGPT (March 2024 version) [Large language model]. Used to apply for all website sections. https://chat.openai.com/chat
